...
const GlowCard: React.FC<GlowCardProps> = ({ 
  ...
  const getInlineStyles = (): React.CSSProperties & Record<string, string | number> => {
    const styles: React.CSSProperties & Record<string, string | number> = {
      ...
      '--radius': '14',
      '--border': '2',
      '--backdrop': backgroundColor || 'hsl(0 0% 60% / 0.07)',
      '--backup-border': backgroundColor ? `${backgroundColor}cc` : 'var(--backdrop)',
      '--size': '250',
      '--outer': '1',
      ...
      backgroundColor: backgroundColor || 'var(--backdrop, transparent)',
