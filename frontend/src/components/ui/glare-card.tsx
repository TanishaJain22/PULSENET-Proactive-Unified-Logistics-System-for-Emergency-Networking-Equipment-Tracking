...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    ...
    "--rainbow":
      "repeating-linear-gradient( 0deg, #2FCC85 calc(var(--step) * 1), #3af0a1 calc(var(--step) * 2), #a8ff5f calc(var(--step) * 3), #83fff7 calc(var(--step) * 4), #2FCC85 calc(var(--step) * 5), #2fcc85 calc(var(--step) * 6), #2FCC85 calc(var(--step) * 7) ) 0% var(--bg-y)/200% 700% no-repeat",
    "--diagonal":
      "repeating-linear-gradient( 128deg, #06100c 0%, #2FCC85 3.8%, #2fcc85 4.5%, #2FCC85 5.2%, #06100c 10%, #06100c 12% ) var(--bg-x) var(--bg-y)/300% no-repeat",
    "--shade":
      "radial-gradient( farthest-corner circle at var(--m-x) var(--m-y),rgba(47,204,133,0.1) 12%,rgba(47,204,133,0.15) 20%,rgba(47,204,133,0.25) 120% ) var(--bg-x) var(--bg-y)/300% no-repeat",
